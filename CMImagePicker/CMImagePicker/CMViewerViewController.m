...
@interface CMViewerViewController ()<UIScrollViewDelegate>

@end

@implementation CMViewerViewController{
...
- (void)loadView {
    ...
    UIGestureRecognizer *gusture = [[UIGestureRecognizer alloc]initWithTarget:self action:@selector(tapImage)];
    _imageView.userInteractionEnabled = YES;
    [_imageView addGestureRecognizer:gusture];
}
